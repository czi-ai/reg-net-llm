...
#         self.transformer_encoder1 = FlashTransformerEncoderLayer(config.model_config.input_dim, config.model_config.num_heads, 
#                                                                  config.model_config.feed_dim, config.model_config.dropout, 
#                                                                  config.model_config.activation, config.model_config.batch_first)
...
#         # take in node embeddings with shape nodes x edim and return the same sized, updated node embeddings
#         combined_embedding = self.transformer_encoder1(combined_embedding) # no shape changes, just updates inputs.
